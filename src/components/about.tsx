      ...
      <div className="container mx-auto">
        <div className="flex flex-wrap">
          ...
          <div className="w-full px-4 lg:w-1/2">
            <h3 className="mb-1 text-2xl font-semibold text-dark lg:pt-10 lg:text-3xl">
              Let's get connected
            </h3>
            <p className="mb-3 max-w-xl font-medium lg:text-lg">
              You can contact me for business or.. maybe just for being friends
              with me! Below are ways of contacting me. I'm open for everyone!
            </p>
            <div className="flex items-center text-slate-700">
              {/* instagram */}
              <a
                href="https://www.instagram.com/mfauzanfikrii/"
                target="_blank"
                title="Instagram"
              ...
              {/* github */}
              <a
                href="https://github.com/mfauzanfikri"
                target="_blank"
                title="GitHub"
                className="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-x-slate-300 hover:border-primary hover:bg-primary hover:text-white"
              >
